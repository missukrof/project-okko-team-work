...
class LFMModel:
    ...
    def df_to_tuple_iterator(
        ...
        :param data: pd.DataFrame, interactions dataframe
        :return: iterator
        """
    ...
    def fit(
        ...
        """
        Trains and saves LightFM model with mapper for further inference
        :param data: pd.DataFrame, train dataframe
        :param user_col: str, name of the user ids column in data
        :param item_col: str, name of the item ids column in data
        :return: None
        """
    ...
    def infer(
        ...
        :param top_n: int, the required number of recommendations for the final output
        :param known_items: Dict[int, List], dictionary of movies known to users: user id as keys,
        list of item ids with which the user interacted in any way as values
        :param enable_logging: bool, enable or disable logging of information
        :return: Dict[str, int], containing recommendations ordered by rank: item (movie) id as keys, rank as values
        """
